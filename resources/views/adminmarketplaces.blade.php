    ...
    <div class="box">
        <div class="header-box">
            <span class="profile">
                ...
                <form action="/admin/marketplaces/tambah" method="post" enctype="multipart/form-data" class="form-tweet">
                    @csrf
    ...
    <div class="box">
            ...
            <li>
                ...
                <span class="profile">
                    ...
                    <div style="font-size: 15px;">
                        <a href="/admin/marketplaces/hapus/{{ $row->id }}">Hapus</a>
                    </div>
        ...
        <div class="show-post">
            ...
            <div hidden id="form{{$row->id}}" class="box">
                <div class="header-box">
                    <span class="profile">
                        <form action="/admin/marketplaces/edit" method="post" class="form-tweet">
                            @csrf
        ...
        <div class="reactions">
            ...
            <div class="gv-react">
                <li>
                    ...
                    <a href="/admin/marketplaces/komentar/{{$row->id}}">
