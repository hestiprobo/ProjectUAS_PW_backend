...
<td>
    <!-- For follow -->
    <div class="recoms">
        <form name="form1" action="/user/marketplaces/komentar/tambah" method="post">
            @csrf
                ...
                <div style="margin-bottom: 22px;" class="header-box">
                    ...
                    <span class="profile">
                        <span class="identity">
                            ...
                            &nbsp;
                            <a style="font-size: 10px;" href="/user/marketplaces/komentar/hapus/{{ $datakomentar->id }}"><i>Hapus</i></a>
                            @else
                            ...
                            <div class="show-post">
                                ...
                                <div hidden id="target{{ $datakomentar->id }}">
                                    <form action="/user/marketplaces/komentar/edit" method="post">
                                        @csrf
