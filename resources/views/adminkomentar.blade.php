...
<td>
    <!-- For follow -->
    <div class="recoms">
        <form name="form1" action="/admin/komentar/kirim" method="post">
            @csrf
                ...
                <div style="margin-bottom: 22px;" class="header-box">
                    ...
                    <span class="profile">
                        <span class="identity">
                            ...
                            &nbsp;
                            <a style="font-size: 10px;" href="/admin/komentar/hapus/{{ $datakomentar->id }}/{{ $datakomentar->id_post }}"><i>Hapus</i></a>
                            @else
                            ...
                            <div class="show-post">
                                ...
                                <div hidden id="target{{ $datakomentar->id }}">
                                    <form action="/admin/komentar/edit" method="post">
                                        @csrf
